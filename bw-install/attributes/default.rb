...
default['bw-install']['install']['bw_version'] = '5.13'
default['bw-install']['install']['tra_version'] = '5.10'
default['bw-install']['install']['tibrv_version'] = '8.4'
default['bw-install']['install']['tibcojre_version'] = '1.8.0'
default['bw-install']['install']['hawk_version'] = '5.2'
default['bw-install']['install']['tpcl_version'] = '5.10'
